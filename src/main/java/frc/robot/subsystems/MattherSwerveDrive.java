...
public class MattherSwerveDrive extends SubsystemBase {
    ...
    public MattherSwerveDrive(RobotBase robot) {
        super(robot);
    ...
    protected void initDefaultCommand() {
        setDefaultCommand(new CommandBase() {
			...
			{
				addRequirements(MattherSwerveDrive.this);
				SendableRegistry.addChild(MattherSwerveDrive.this, this);
			}
